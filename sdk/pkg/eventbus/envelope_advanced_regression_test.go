...
func TestNewEnvelopeWithAutoID(t *testing.T) {
	payload := []byte(`{"key":"value"}`)
	env := NewEnvelopeWithAutoID("agg-123", "test.event", 1, payload)
